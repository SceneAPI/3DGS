...
MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'display_name': 'Brush',
 'entry_points': ['sfmapi_brush.plugin:plugin'],
 ...
 'runtime_modes': {'container_service': {'cache': {'path': '/sfmapi/cache',
                   ...
                   'docker': {'build_context': 'https://github.com/SFMAPI/sfmapi_brush.git',
                              'image': None},
                   'external_tool': None,
                   'uv': {'package': 'sfmapi-brush',
                          'ref': 'main',
                          'source': 'git',
