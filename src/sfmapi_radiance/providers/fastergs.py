...
MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'entry_points': ['sfmapi_fastergs.plugin:plugin'],
 'github_url': 'https://github.com/SFMAPI/sfmapi_fastergs.git',
 'licenses': [{'name': 'Apache-2.0'}],
 'package_name': 'sfmapi-fastergs',
 'plugin_id': 'fastergs',
 ...
 'runtime_modes': {'container_service': {'cache': {'path': '/sfmapi/cache',
                                         ...
                                         'image': {'build': {'args': {'SFMAPI_FASTERGS_REF': 'main',
                                                                      'TORCH_DEVICE': 'cuda',
                                                                      'TORCH_INDEX_URL': 'https://download.pytorch.org/whl/cu128',
                                                                      'TORCH_PACKAGES': 'torch '
                                                                                        'torchvision '
                                                                                        'torchaudio'},
                                                             'context': 'https://github.com/SFMAPI/sfmapi_fastergs.git',
                                                             'dockerfile': 'Dockerfile',
                                                             'ref': 'main',
                                                             'source': 'git'}},
                                         'object_store': {'input_prefix': 'fastergs/input/',
                   ...
                   'docker': {'build_context': 'https://github.com/SFMAPI/sfmapi_fastergs.git',
                              'image': None},
                   'external_tool': None,
                   'uv': {'package': 'sfmapi-fastergs',
                          'ref': 'main',
                          'source': 'git',
                          'url': 'https://github.com/SFMAPI/sfmapi_fastergs.git'}},
