...
MANIFEST: dict[str, Any] = {'schema_version': 1,
 ...
 'entry_points': ['sfmapi_spirulae.plugin:plugin'],
 'github_url': 'https://github.com/SFMAPI/sfmapi_spirulae.git',
 'licenses': [{'name': 'Apache-2.0'}],
 'package_name': 'sfmapi-spirulae',
 'plugin_id': 'spirulae',
 'providers': [{'backend_actions': ['spirulae.*'],
                'capabilities': ['radiance.train',
                                 'radiance.evaluate',
                                 'radiance.metrics.psnr',
                                 'radiance.metrics.ssim',
 ...
 'runtime_modes': {'container_service': {'cache': {'path': '/sfmapi/cache',
                                         ...
                                         'image': {'build': {'args': {'SFMAPI_SPIRULAE_REF': 'master',
                                                                      'TORCH_DEVICE': 'cuda',
                                                                      'TORCH_INDEX_URL': 'https://download.pytorch.org/whl/cu128',
                                                                      'TORCH_PACKAGES': 'torch '
                                                                                        'torchvision '
                                                                                        'torchaudio'},
                                                             'context': 'https://github.com/SFMAPI/sfmapi_spirulae.git',
                                                             'dockerfile': 'Dockerfile',
                                                             'ref': 'master',
                                                             'source': 'git'}},
                                         'object_store': {'input_prefix': 'spirulae/input/',
                                         ...
                                         'service': {'default_url': 'http://127.0.0.1:8094',
                                                     'url_env': 'SFMAPI_SPIRULAE_SERVICE_URL'}},
                   'docker': {'build_context': 'https://github.com/SFMAPI/sfmapi_spirulae.git',
                              'image': None},
                   'external_tool': None,
                   'uv': {'package': 'sfmapi-spirulae',
                          'ref': 'master',
                          'source': 'git',
                          'url': 'https://github.com/SFMAPI/sfmapi_spirulae.git'}},
